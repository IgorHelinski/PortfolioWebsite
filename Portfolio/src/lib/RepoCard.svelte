<script>
    // credit: https://github.com/tarptaeya/repo-card
    ...
    <div style="font-family: -apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji; border: 1px solid ${theme.borderColor}; border-radius: 6px; background: ${theme.background}; padding: 16px; font-size: 14px; line-height: 1.5; color: #24292e;">
      <div style="display: flex; align-items: center;">
        ...
        <span style="font-weight: 600; color: ${theme.linkColor};">
          <a style="text-decoration: none; color: inherit;" href="${data.html_url}" target="_blank" rel="noopener noreferrer">${data.name}</a>
        </span>
      </div>
...
export let repoUrl = "IgorHelinski/MyImageOperations";
export let cardWidth = 400;

</script>

<div class="repo-card" data-repo="{repoUrl}" style="width: {cardWidth}px; float:left;"></div>